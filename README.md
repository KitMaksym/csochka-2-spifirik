...
напиши в дс если проблемы #kit_maksym
я тестил в хроме и работает
это не может быть вирусом ведь есть исходный код
поставь этот браузер по умолчанию с этим скриптом и все будет норм
админы увидят это и возможно сделаю фейк приложения которое будет просто отсылать что ты ничего не сделал на реальные сервера
удали мой комент когда прочитал чтоб никто не увидел из администраторов
